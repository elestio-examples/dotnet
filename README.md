# .NET example demo CI/CD pipeline
...
Example application and CI/CD pipeline showing how to deploy a .NET application to elestio.

<img src="wwwroot\images\screenshot.jpg" alt="screenshot of the example app" width="100%" />
...
But for this .NET application example, you can choose GitHub as your deployment method.

### Step 3: Authentication

If you forked the repo then you can click on the sign-in with GitHub button and authorize elestio to access the git repo then you can select the dotnet repo otherwise you can directly insert a git repo URL to deploy the .NET application.
